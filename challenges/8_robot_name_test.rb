...
class RobotTest < Minitest::Test
  ...
  # def test_gen_chars
  #   # change `generate_chars` to public method to test
  #   assert_match /\d{3}$/, Robot.new.generate_chars(3, ('0'..'9').to_a)
  #   assert_match /^[A-Z]{2}/, Robot.new.generate_chars(2, ('A'..'Z').to_a)
  # end
